...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "UPDATE menu SET namamenu = '$namamenu', harga = '$harga' WHERE idmenu = '$id'";
...
<head>
    ...
    <title>Edit Menu - Sistem Kasir</title>
                    ...
                    <div class="card-body">
                        <form method="POST">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="namamenu" name="namamenu" value="<?php echo htmlspecialchars($menu['namamenu']); ?>" required>
                            </div>
                            <div class="mb-3">
