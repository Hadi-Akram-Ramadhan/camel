                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="namameja" name="namameja"
                                        value="<?php echo htmlspecialchars($meja['namameja']); ?>" required>
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" id="kapasitas" name="kapasitas"
                                        value="<?php echo $meja['kapasitas']; ?>" required>
                                </div>
                            </div>
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-select" id="status" name="status" required>
                                        <option value="tersedia"
                                            <?php echo $meja['status'] == 'tersedia' ? 'selected' : ''; ?>>
                                            Tersedia
                                        </option>
                                        <option value="terisi"
                                            <?php echo $meja['status'] == 'terisi' ? 'selected' : ''; ?>>
                                            Terisi
                                        </option>
                                    </select>
                                </div>
