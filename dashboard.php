        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="pages/user/"><i class="bi bi-people"></i> User</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="auth/logout.php"><i class="bi bi-box-arrow-right"></i>
                                    Logout</a></li>
                        </ul>
                    </li>
                </div>
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="card bg-danger text-white">
                                    <div class="card-body">
                                        <h5><i class="bi bi-people"></i> Kelola User</h5>
                                        <a href="pages/user/" class="btn btn-light mt-2">Akses</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 mb-3">
